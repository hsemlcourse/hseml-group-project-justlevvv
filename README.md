...
## Результаты (Checkpoint 2)

| Модель                 | Accuracy | Precision (Yes) | Recall (Yes) | F1 (Yes) | ROC-AUC | PR-AUC |
|------------------------|----------|-----------------|--------------|----------|---------|--------|
| Dummy (most_frequent)  | 0.80     | 0.00            | 0.00         | 0.00     | 0.50    | 0.20   |
...
| Ensemble (Voting)      | 0.69     | 0.21            | 0.21         | 0.21     | 0.51    | 0.21   |

**Лучшая модель:** Linear SVC (F1=0.29) после подбора гиперпараметров.  
Вывод: из-за слабой корреляции признаков с целевой переменной все модели показывают скромные результаты, но лучшие из них (насколько это возможно) - Linear SVC, Logistic Regression.
